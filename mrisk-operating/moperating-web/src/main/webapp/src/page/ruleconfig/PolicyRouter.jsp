...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/src/js/app/page/policyRoute.js'/>"></script>
...
<div class="content">
    <div class="dot-shuxing">
        <%@include file="part/PolicyRouterForm.jsp"%>
        ...
        <c:forEach items="${routerList}" var="policyRouter" varStatus="routerIndex">
            <%@include file="part/PolicyRouterDetail.jsp" %>
        </c:forEach>
    </div>
</div>
</body>
