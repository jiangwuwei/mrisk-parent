...
/*      var str1 = '<li><a href="javascript:" class="'+ active +'">1</a></li>';
      ...
      var preStr = '<li><a href="javascript:"';
      var str1 = preStr;
      if(currentPage == 1){
        str1 = str1 + 'class="'+ active +'">1</a></li>';
      }else{
        str1 = str1 + '>1</a></li>';
      }
      if (l > 1&&l < n+1) {
          for (i = 2; i < l + 1; i++) {
           if(currentPage == i){
            str += preStr + 'class="'+ active +'">'+i+'</a></li>';
          }else{
            str += preStr + '>'+i+'</a></li>';
          }
        }
      ...
      dataHtml += '<div class="totalPages">每页显示'+opts.limit+'条记录，共'+opts.totalCount+'条记录</div>'
