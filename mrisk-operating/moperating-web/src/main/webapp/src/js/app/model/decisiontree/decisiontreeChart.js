        ...
        series: [
            {
                ...
                nodePadding: 100,  //左右间距
                layerPadding: 40,  //上下间距
                symbolSize: 16,
                itemStyle: {
                    normal: {
                        label: {
...
function eConsole(param) {
    var urlParam = {
        "nodeId": param.data.id,
        "sceneNo": $("#sceneNo").val(),
        "branchParentId": param.data.parentId
        , "nodeType": param.data.nodeType
    };
    $("#treeDetail").load($("#basePath").val() + "/dt/findNodesById.do", urlParam,
