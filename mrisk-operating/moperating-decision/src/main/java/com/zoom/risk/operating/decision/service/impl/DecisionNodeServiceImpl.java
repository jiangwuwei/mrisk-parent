...
import com.zoom.risk.operating.decision.exception.InvalidNodeException;
...
public class DecisionNodeServiceImpl implements DecisionNodeService {
    ...
    public DBNode buildDecisionTree(List<DBNode> list){
        return buildDecisionTree(list,true);
    }
    /**
     * 根据policyId查找所有节点，然后调用此方法获取节点树的根节点
     * @param list
     * @return
     */
