 ...
 *Sep 23, 2015
 */
@ContextExtendedAnnotation(value = "challengeNumberExtension",order = 3, includes = {RiskResult.RISK_BUSI_TYPE_ANTIFRAUD,RiskResult.RISK_BUSI_TYPE_DECISION_TREE,RiskResult.RISK_BUSI_TYPE_SCARD})
