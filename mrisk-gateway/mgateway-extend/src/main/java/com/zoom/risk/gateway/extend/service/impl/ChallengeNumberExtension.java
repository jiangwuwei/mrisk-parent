 ...
 *Sep 23, 2016
 */
@ContextAnnotation(value = "challengeNumberExtension",order = 3, includes = {RiskResult.RISK_BUSI_TYPE_ANTIFRAUD,RiskResult.RISK_BUSI_TYPE_DECISION_TREE,RiskResult.RISK_BUSI_TYPE_SCARD})
