 ...
 *Oct 26, 2015
 */
@Invoker(value="minivisionBlacklistAdapter",serviceName = "minivisionBlacklistEntryService")
public class MinivisionBlacklistAdapter implements InvokerService {
    private static final Logger logger = LogManager.getLogger(MinivisionBlacklistAdapter.class);
    ...
    public RpcResult<Map<String, Object>> invoke(Map<String, Object> riskInput) {
        ...
        if(useMock){
            ...
            try {
                Map<String, Object> result = minivisionBlacklistService.invoke(idCardNumber, userName, mobile);
        ...
        logger.info("MinivisionBlacklistAdapter's result Map : {}", JSON.toJSONString(rpcResult));
        return rpcResult;
    }
